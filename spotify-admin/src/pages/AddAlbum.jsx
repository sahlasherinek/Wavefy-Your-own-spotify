...
function AddAlbum() {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            const errorMessage = error.response?.data?.message || error.response?.data?.error || "Album Add Error";
        ...
        <form onSubmit={onSubmitHandler} className="flex flex-col items-start gap-8 text-gray-600">
            <div className="flex gap-8">
                <div className="flex flex-col gap-4">
                    ...
                    <label htmlFor="image">
                        <img src={image ? URL.createObjectURL(image) : assets.upload_area}  style={{ width: "150px", height: "150px", objectFit: "cover", borderRadius: "8px" }} className="w-24 cursor-pointer" alt="upload_area" />
                    </label>
                </div>
            </div>
